...
DROP TABLE IF EXISTS ${db}_grid_drain_class ;
CREATE TABLE ${db}_grid_drain_class AS
...
-- index
CREATE INDEX ${db}_grid_drain_class_idx ON ${db}_grid_drain_class (grid_gid);
VACUUM ANALYZE ${db}_grid_drain_class;
