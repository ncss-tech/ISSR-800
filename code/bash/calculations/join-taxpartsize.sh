...
DROP TABLE IF EXISTS ${db}_grid_taxpartsize_class;
CREATE TABLE ${db}_grid_taxpartsize_class AS
...
-- index
CREATE INDEX ${db}_grid_taxpartsize_class_idx ON ${db}_grid_taxpartsize_class (grid_gid);
VACUUM ANALYZE ${db}_grid_taxpartsize_class;
