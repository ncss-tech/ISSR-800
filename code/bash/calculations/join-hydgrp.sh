...
DROP TABLE IF EXISTS ${db}_grid_hydgrp_class ;
CREATE TABLE ${db}_grid_hydgrp_class AS
...
-- index
CREATE INDEX ${db}_grid_hydgrp_class_idx ON ${db}_grid_hydgrp_class (grid_gid);
VACUUM ANALYZE ${db}_grid_hydgrp_class;
